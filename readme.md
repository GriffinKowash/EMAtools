...
The default dimensions of [timestep, X/Y/Z component, sample point] can be changed by providing the optional `last_index` argument. For example, the following will return a `data` array with dimensions of [time, sample, component]:
